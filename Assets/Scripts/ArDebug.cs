...
public class ArDebug : MonoBehaviour
{
    ...
    public TextMeshProUGUI debugText;       // Assign your TMP text object here
    public float updateInterval = 1f;       // How often to update the position text
    ...
    void Start()
    {
        ...
        StartCoroutine(UpdateDebugPosition());
    }

    IEnumerator UpdateDebugPosition()
    {
        while (true)
        {
